"""
AtomicScraper — desktop application
...
from atomicscraper.industries import INDUSTRIES
...
LICENSE_FILE = Path.home() / "AppData" / "Local" / "AtomicScraper" / "license.txt"
...
def _validate_license(key: str) -> tuple:
    ...
    try:
        ...
        r = requests.post(
            ...
            json={"license_key": key, "product": "atomicscraper", "machine_id": MACHINE_ID},
            timeout=5,
...
def _apply_treeview_style():
    ...
    style.configure("Treeview",
        background="#081518", foreground="#B2DFDB",
        fieldbackground="#081518", rowheight=26,
        font=("Consolas", 10))
    style.configure("Treeview.Heading",
        background="#0A1A1C", foreground="#00BCD4",
        relief="flat", font=("Consolas", 10, "bold"))
    style.map("Treeview",
        background=[("selected", "#003D44")],
        foreground=[("selected", "#FFFFFF")])
    style.map("Treeview.Heading",
        background=[("active", "#0A1A1C")])


class LicenseBar(ctk.CTkFrame):
    def __init__(self, parent, on_activate: callable, **kw):
        super().__init__(parent, height=44, fg_color="#060E0F", corner_radius=0, **kw)
        self.grid_propagate(False)
        self.on_activate = on_activate
        self._licensed = False

        ctk.CTkLabel(self, text="ATOMICSCRAPER",
                      font=ctk.CTkFont(size=15, weight="bold"),
                      text_color="#00BCD4").pack(side="left", padx=12)
        ...
        self.key_entry = ctk.CTkEntry(
            self, placeholder_text="License key (e.g. AS-XXXX-XXXX)",
...
class LeadsTable(ctk.CTkFrame):
    def __init__(self, parent, **kw):
        super().__init__(parent, fg_color="#060E0F", corner_radius=0, **kw)
        self.grid_rowconfigure(1, weight=1)
        self.grid_columnconfigure(0, weight=1)

        # Search bar
        search_bar = ctk.CTkFrame(self, fg_color="#0A1A1C", height=36, corner_radius=0)
        ...
        self.lead_count_lbl = ctk.CTkLabel(
            ...
            font=ctk.CTkFont(size=11, weight="bold"), text_color="#00BCD4")
        ...
        tree_frame = tk.Frame(self, bg="#081518")
...
class LeftPanel(ctk.CTkFrame):
    def __init__(self, parent, on_start, on_stop, **kw):
        super().__init__(parent, width=270, corner_radius=0, fg_color="#0A1A1C", **kw)
        self.grid_propagate(False)
    ...
    def _build_industry_section(self):
        ...
        ctk.CTkLabel(top, text="INDUSTRIES",
                      font=ctk.CTkFont(size=11, weight="bold"),
                      text_color="#607D8B").pack(side="left")
        ...
        scroll = ctk.CTkScrollableFrame(self, fg_color="#0F2225", label_text="")
    ...
    def _build_config_section(self):
        cfg = ctk.CTkFrame(self, fg_color="#0F2225")
        ...
        def _row(parent, label, default, row):
            ...
            ctk.CTkLabel(f, text=label, width=72, anchor="w",
                          text_color="#B2DFDB").pack(side="left")
        ...
        ctk.CTkLabel(cfg, text="CUSTOM KEYWORD",
                      font=ctk.CTkFont(size=11, weight="bold"),
                      text_color="#607D8B").pack(anchor="w", padx=10, pady=(10, 2))
        ...
        ctk.CTkLabel(cfg, text="LOCATION",
                      font=ctk.CTkFont(size=11, weight="bold"),
                      text_color="#607D8B").pack(anchor="w", padx=10, pady=(4, 2))
        ...
        ctk.CTkCheckBox(cfg, text="Extract Emails + Platform",
                         ...
                         border_color="#00BCD4").pack(anchor="w", padx=10, pady=2)
        ctk.CTkCheckBox(cfg, text="Fast mode (~20 results/query)",
                         variable=self.platform_var,
                         checkmark_color="#00BCD4",
                         border_color="#00BCD4").pack(anchor="w", padx=10, pady=(2, 10))
...
class LogPanel(ctk.CTkFrame):
    def __init__(self, parent, **kw):
        ...
        self.box = ctk.CTkTextbox(
            ...
            fg_color="#060E0F", text_color="#B2DFDB",
...
class App(ctk.CTk):
    def __init__(self):
        ...
        right = ctk.CTkFrame(self, fg_color="#060E0F", corner_radius=0)
        ...
        sep = ctk.CTkFrame(right, height=1, fg_color="#003D44")
        ...
        ctk.CTkLabel(status_frame,
                      ...
                      font=ctk.CTkFont(family="Consolas", size=10),
                      text_color="#607D8B").pack(side="left", padx=8)
    ...
    def _start(self):
        ...
        self.status_lbl.configure(text="● RUNNING", text_color="#00BCD4")
    ...
    def _run_jobs(self, cfg: dict):
        leads_folder = Path.home() / "Documents" / "AtomicScraper Leads"
    ...
    def _done(self):
        ...
        self.status_lbl.configure(text="● READY", text_color="#00BCD4")
        self.table.refresh_from_db()
        self._log("[SYSTEM] All jobs finished.")

    def _stop(self):
        self.engine.stop()
        self.status_lbl.configure(text="● STOPPING...", text_color="#0097A7")
