...
class ScraperEngine:
    ...
    def run_industry(
        ...
        headless: bool = True,
        on_lead: Callable = None,  # called with each enriched lead dict
    ) -> bool:
        ...
        self.log(f"Settings: depth={depth}, enrich={extract_email}")
        ...
        try:
            ...
            enriched = self._enrich_batch(unique, extract_email=extract_email, on_lead=on_lead)
    ...
    def _enrich_batch(self, leads: list, extract_email: bool, on_lead: Callable) -> list:
        ...
        # Run enrichment with a thread pool (I/O bound — websites)
        results = []
