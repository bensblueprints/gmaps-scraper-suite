"""
Leads.Baby — desktop scraper + CRM application.
"""
import re
import sys
import json
...
PRODUCT_NAME  = "Leads.Baby"
PRODUCT_COLOR = "#FF6B9D"
LEADS_FOLDER  = "LeadsBaby Leads"
APP_DATA_DIR  = Path.home() / "AppData" / "Local" / "LeadsBaby"
