"""
Discovery1 — desktop application
...
from discovery1.industries import INDUSTRIES
...
LICENSE_FILE = Path.home() / "AppData" / "Local" / "Discovery1" / "license.txt"
...
def _validate_license(key: str) -> tuple:
    ...
    try:
        ...
        r = requests.post(
            ...
            json={"license_key": key, "product": "discovery1", "machine_id": MACHINE_ID},
            timeout=5,
...
def _apply_treeview_style():
    ...
    style.configure("Treeview",
        background="#1E1E0E", foreground="#D4C5A9",
        fieldbackground="#1E1E0E", rowheight=26,
        font=("Consolas", 10))
    style.configure("Treeview.Heading",
        background="#252510", foreground="#E67E22",
        relief="flat", font=("Consolas", 10, "bold"))
    style.map("Treeview",
        background=[("selected", "#4A2800")],
        foreground=[("selected", "#FFFFFF")])
    style.map("Treeview.Heading",
        background=[("active", "#2D2310")])


class LicenseBar(ctk.CTkFrame):
    def __init__(self, parent, on_activate: callable, **kw):
        super().__init__(parent, height=44, fg_color="#0F0F0A", corner_radius=0, **kw)
        self.grid_propagate(False)
        self.on_activate = on_activate
        self._licensed = False

        ctk.CTkLabel(self, text="DISCOVERY1",
                      font=ctk.CTkFont(size=15, weight="bold"),
                      text_color="#E67E22").pack(side="left", padx=12)
...
class LeadsTable(ctk.CTkFrame):
    def __init__(self, parent, **kw):
        super().__init__(parent, fg_color="#0F0F0A", corner_radius=0, **kw)
        self.grid_rowconfigure(1, weight=1)
        self.grid_columnconfigure(0, weight=1)

        # Search bar
        search_bar = ctk.CTkFrame(self, fg_color="#1A1A0F", height=36, corner_radius=0)
        ...
        tree_frame = tk.Frame(self, bg="#1E1E0E")
...
class LeftPanel(ctk.CTkFrame):
    def __init__(self, parent, on_start, on_stop, **kw):
        super().__init__(parent, width=270, corner_radius=0, fg_color="#1A1A0F", **kw)
        self.grid_propagate(False)
    ...
    def _build_industry_section(self):
        ...
        ctk.CTkLabel(top, text="INDUSTRIES",
                      font=ctk.CTkFont(size=11, weight="bold"),
                      text_color="#8C7B65").pack(side="left")
        ...
        scroll = ctk.CTkScrollableFrame(self, fg_color="#252510", label_text="")
    ...
    def _build_config_section(self):
        cfg = ctk.CTkFrame(self, fg_color="#252510")
        ...
        def _row(parent, label, default, row):
            ...
            ctk.CTkLabel(f, text=label, width=72, anchor="w",
                          text_color="#D4C5A9").pack(side="left")
        ...
        ctk.CTkLabel(cfg, text="CUSTOM KEYWORD",
                      font=ctk.CTkFont(size=11, weight="bold"),
                      text_color="#8C7B65").pack(anchor="w", padx=10, pady=(10, 2))
        ...
        ctk.CTkLabel(cfg, text="LOCATION",
                      font=ctk.CTkFont(size=11, weight="bold"),
                      text_color="#8C7B65").pack(anchor="w", padx=10, pady=(4, 2))
        ...
        ctk.CTkCheckBox(cfg, text="Extract Emails + Platform",
                         ...
                         checkmark_color="#E67E22",
                         border_color="#E67E22").pack(anchor="w", padx=10, pady=2)
        ctk.CTkCheckBox(cfg, text="Fast mode (~20 results/query)",
                         variable=self.platform_var,
                         checkmark_color="#E67E22",
                         border_color="#E67E22").pack(anchor="w", padx=10, pady=(2,10))
...
class LogPanel(ctk.CTkFrame):
    def __init__(self, parent, **kw):
        ...
        self.box = ctk.CTkTextbox(
            ...
            fg_color="#0F0F0A", text_color="#D4C5A9",
...
class App(ctk.CTk):
    def __init__(self):
        ...
        right = ctk.CTkFrame(self, fg_color="#0F0F0A", corner_radius=0)
        ...
        sep = ctk.CTkFrame(right, height=1, fg_color="#3A2800")
        ...
        ctk.CTkLabel(status_frame,
                      ...
                      font=ctk.CTkFont(family="Consolas", size=10),
                      text_color="#8C7B65").pack(side="left", padx=8)
    ...
    def _start(self):
        ...
        self.status_lbl.configure(text="● RUNNING", text_color="#E67E22")
    ...
    def _run_jobs(self, cfg: dict):
        leads_folder = Path.home() / "Documents" / "Discovery1 Leads"
    ...
    def _done(self):
        ...
        self.status_lbl.configure(text="● READY", text_color="#E67E22")
        self.table.refresh_from_db()
        self._log("[SYSTEM] All jobs finished.")

    def _stop(self):
        self.engine.stop()
        self.status_lbl.configure(text="● STOPPING...", text_color="#D35400")
